...
This is the [Woodplane](https://Woodplane.com) Theme. It has an object oriented php architecture and comes with some very handy build workflows.
...
The initial setup was done with Node `v14.17.1 (with npm 6.14.13)`
